...
document.querySelector("#calinv").onclick = (e) => {
    let sp = new URL(window.location.href).searchParams;
    if (sp.has("loc")) fetch(`${OUTREACH_SERVER}/${sp.get("loc")}/caladd`);
    if (!IS_MOBILE) {
        e.preventDefault();
        window.open("https://calendar.google.com/calendar/render?action=TEMPLATE&dates=20231014T120000Z%2F20231014T173000Z&location=836%20Deerfield%20Rd%2C%20Deerfield%2C%20IL&text=Deerfield%20Robotics%20at%20the%20Farmer%27s%20Market");
    }
};